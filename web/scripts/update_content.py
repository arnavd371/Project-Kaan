    ...
    en.update(
        {
            ...
            "about_deployment": (
                "Publicly deployed at kaan-web.vercel.app and open-sourced under MIT on GitHub "
                "(arnavd371/kaan-web and arnavd371/Project-Kaan), including the full training "
